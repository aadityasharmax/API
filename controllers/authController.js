              ...
              <table width="90%" align="center" cellpadding="0" cellspacing="0" style="text-align: center; border-radius:8px; box-shadow:0 2px 8px rgba(0,0,0,0.04);">
                <tr>
                  <td style="padding:25px;">
                    <h2 style="color:#15552e; font-size:22px; font-weight:600; margin:0; padding:0 0 12px 0;">Verify Your Email Address</h2>
                    <p style="color:#15552e; font-size:15px; margin:0; padding-bottom:7px;">
                ...
                <!-- Expiry Info -->
                <tr>
                  <td align="center" style="color:#15552e; font-size:13px; padding-bottom:10px;">
                    This link will expire in 24 hours. If you didn't create an account, you can safely ignore this email.
                  </td>
                </tr>
                <!-- Small Footer -->
                <tr>
                  <td align="center" style="color:#15552e; font-size:12px; padding-bottom:8px;">
